...
..\bin\mesecina3d --nogui -mode medrep-surface -input %1 >log\medrep-surface_%1_%timestamp%.txt
mkdir %1\log
move log\medrep-surface_%1_%timestamp%.txt %1\log\medrep-surface_%1_%timestamp%.txt
