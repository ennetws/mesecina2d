...
..\bin\mesecina3d --nogui -mode medrep-basic -input %1.off -m2b2m %conversion% >log\medrep-basic_%1_%conversion%_%timestamp%.txt
mkdir %1-%conversion%\log
move log\medrep-basic_%1_%conversion%_%timestamp%.txt %1-%conversion%\log\medrep-basic_%1_%conversion%_%timestamp%.txt
