  ...
  : fieldOfView_(M_PI/4.0f)
{
  ...
  setZNearCoefficient(0.001f); // changed to something lower to be able to zoom in deeper
...
void Camera::setSceneCenter(const Vec& center)
{
  sceneCenter_ = center;
  /// ADDED FOR MESECINA BEGIN
  // setRevolveAroundPoint(sceneCenter()); /// removed by balint, because I don't want to center when I update bounding box
  /// ADDED FOR MESECINA END
}
