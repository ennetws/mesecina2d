...
TARGET = QGLViewer2
# VERSION = 2.3.1
# CONFIG -= debug debug_and_release # Modified for Mesecina
CONFIG *= release qt opengl warn_on shared thread create_prl rtti

# BEGIN Modifications for MESECINA
...
win32 {
	...
	GUID = {53642F4E-AE40-37CD-85D9-55A2CDA0B306}
	CONFIG -= flat
}
QMAKE_CXXFLAGS_DEBUG += /Fdqglviewer2.pdb
# END Modifications for MESECINA
...
win32 {
  staticlib {
	...
	MOC_DIR =  ..\..\win\moc-qglviewer
	CONFIG(release) {
		OBJECTS_DIR = ..\..\win\release\obj-qglviewer
	}
	CONFIG(debug) {
		OBJECTS_DIR = ..\..\win\debug\obj-qglviewer
	}
